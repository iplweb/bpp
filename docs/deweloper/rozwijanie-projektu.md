...
Zgłaszaj błędy w oprogramowaniu pod adresem
[github.com/iplweb/bpp/issues](https://github.com/iplweb/bpp/issues).

Jeżeli zgłaszasz błąd, prosimy, opisz:

- Twój system operacyjny i wersję przeglądarki WWW,
- szczegóły dotyczące konfiguracji Twojego komputera, które mogą pomóc
  w powieleniu a następnie usunięciu błędu,
...
Przejrzyj zgłoszenia na GitHub w poszukiwaniu zgłoszeń zawierających
zapotrzebowanie na nowe funkcje. Wszystko, co oznaczone "enhancement"
lub "help wanted" czeka na osobę, która się tym zajmie.
...
- Pamiętaj, że ten projekt rozwijany jest na zasadach opensource i Twój wkład
  jest mile widziany
