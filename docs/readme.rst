...
Oprogramowanie dystrybuowane jest na zasadach otwartoźródłowej `licencji MIT`_.

Pełne informacje o projekcie znajdują się w pliku `README.md`_ w głównym
katalogu repozytorium.

.. _licencji MIT: https://pl.wikipedia.org/wiki/Licencja_MIT
.. _README.md: https://github.com/iplweb/bpp/blob/dev/README.md
