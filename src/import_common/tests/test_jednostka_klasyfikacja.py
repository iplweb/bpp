...
def test_sklasyfikuj_brak_dopasowania(uczelnia):
    baker.make(Jednostka, nazwa="Instytut Fizyki Jądrowej", skrot="IFJ", uczelnia=uczelnia)
    jednostka, status, sim = sklasyfikuj_jednostke("Zakład Transfuzjologii")
...
def test_sklasyfikuj_remis_prefiksowy_nie_rzuca(uczelnia):
    ...
    baker.make(Jednostka, nazwa="Zakład Biologii Molekularnej", skrot="ZBM", uczelnia=uczelnia)
    baker.make(Jednostka, nazwa="Zakład Biologii Komórki", skrot="ZBK", uczelnia=uczelnia)
