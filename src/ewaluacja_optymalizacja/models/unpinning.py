"""Model przechowujący wyniki analizy możliwości odpinania publikacji.

Identyfikuje publikacje wieloautorowe, w których odpięcie autora A
(mającego pełne sloty) może pozwolić autorowi B uzyskać wyższy udział.
"""
