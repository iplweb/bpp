...
def test_matchuj_jednostke(szukany_string, uczelnia, wydzial, db):
    j1 = mommy.make(Jednostka, nazwa="Jednostka Pierwsza", wydzial=wydzial, uczelnia=uczelnia)
    j2 = mommy.make(Jednostka, nazwa="Jednostka Pierwsza i Jeszcze", wydzial=wydzial, uczelnia=uczelnia)
