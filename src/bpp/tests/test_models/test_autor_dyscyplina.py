...
def test_autor_dyscyplina_dopisanie_regula_nr_1(
        autor_jan_kowalski, dyscyplina1, dyscyplina2, wydawnictwo_ciagle, rok, jednostka, typy_odpowiedzialnosci
):
    wydawnictwo_ciagle.rok = rok
    wydawnictwo_ciagle.save()

    wca = wydawnictwo_ciagle.dodaj_autora(autor_jan_kowalski, jednostka, dyscyplina_naukowa=None)

    Autor_Dyscyplina.objects.create(
        autor=autor_jan_kowalski, rok=rok,
        dyscyplina_naukowa=dyscyplina1,
        subdyscyplina_naukowa=dyscyplina2
    )
...
def test_autor_dyscyplina_zmiana_dyscypliny_regula_2(
        autor_jan_kowalski, jednostka, dyscyplina1, dyscyplina2,
        dyscyplina3,
        rok, wydawnictwo_ciagle, wydawnictwo_zwarte,
...
def test_autor_dyscyplina_zmiana_subdyscypliny_na_pusta_regula_3(
        autor_jan_kowalski, jednostka, dyscyplina1, dyscyplina2,
        rok, wydawnictwo_ciagle, typy_odpowiedzialnosci):
    """Sprawdź, czy zmiana przypisania Autor_Dyscyplina na dany rok pociągnie zmianę w wydawnictwach
...
def test_autor_dyscyplina_zmiana_dyscypliny_regula_4(
    ...
    wza.refresh_from_db()
    assert wza.dyscyplina_naukowa == None
