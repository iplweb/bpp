...
Większe per-komendę grupy testów wydzielono do osobnych plików, żeby trzymać
wszystkie pliki pod 850 linii:

- ``test_management_commands_oplaty.py`` -- komendy z grupy „oplaty”
- ``test_management_commands_ustaw_daty_oswiadczenia_pbn.py`` --
  ``ustaw_daty_oswiadczenia_pbn``
- ``test_management_commands_fix_import_dat_oswiadczen_pbn.py`` --
  ``fix_import_dat_oswiadczen_pbn``

Tutaj zostają lekkie komendy administracyjne (rebuild_*, set_site_name,
odtworz_grupy itd.) plus testy legacy.
"""
