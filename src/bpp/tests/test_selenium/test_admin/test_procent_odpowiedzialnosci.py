...
from bpp.tests import set_element, submit_admin_form, \
...
def test_procent_odpowiedzialnosci_baseModel_AutorFormset_jeden_autor(
    ...
    fill_admin_inline(preauth_admin_browser, autor=autor_jan_kowalski, jednostka=jednostka, zapisany_jako="Kopara",
                      procent="100.00")
...
def test_procent_odpowiedzialnosci_baseModel_AutorFormset_dwoch_autorow(
    ...
    fill_admin_inline(preauth_admin_browser, autor=autor_jan_nowak, jednostka=jednostka, zapisany_jako="Kopara",
                      procent="50.00", no=1)
    submit_admin_form(preauth_admin_browser)
    assert submitted_form_good(preauth_admin_browser)
