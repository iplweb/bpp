...
CREATE VIEW bpp_patent_view AS SELECT
  ...
  '0'::int AS liczba_znakow_wydawniczych,
  '0.00'::numeric(8,2) AS liczba_arkuszy_wydawniczych,
...
ALTER TABLE bpp_rekord_mat DROP COLUMN www;
ALTER TABLE bpp_rekord_mat ADD COLUMN liczba_arkuszy_wydawniczych numeric(8,2);
ALTER TABLE bpp_rekord_mat ADD COLUMN www VARCHAR;

CREATE INDEX bpp_rekord_mat_liczba_arkuszy_wydawniczych
    ON bpp_rekord_mat(liczba_arkuszy_wydawniczych);
