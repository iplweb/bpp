...
SELECT ARRAY [
       ...
       bpp_wydawnictwo_ciagle.utworzono AS utworzono,
       bpp_wydawnictwo_ciagle.ostatnio_zmieniony AS ostatnio_zmieniony,
       ...
       slowa_kluczowe_eng  AS slowa_kluczowe_eng,
...
SELECT ARRAY [
       ...
       bpp_wydawnictwo_zwarte.utworzono AS utworzono,
       bpp_wydawnictwo_zwarte.ostatnio_zmieniony AS ostatnio_zmieniony,
...
SELECT ARRAY [
       ...
       bpp_patent.utworzono AS utworzono,
       bpp_patent.ostatnio_zmieniony AS ostatnio_zmieniony,
...
CREATE INDEX bpp_rekord_mat_o_o
    ON bpp_rekord_mat (openaccess_data_opublikowania);
