...
SELECT ARRAY [
       ...
       (SELECT id
        ...
        WHERE bpp_typ_odpowiedzialnosci.skrot = 'aut.') AS typ_odpowiedzialnosci_id,
...
DROP INDEX IF EXISTS foo2;

CREATE INDEX IF NOT EXISTS bpp_autorzy_mat_8 ON bpp_autorzy_mat (dyscyplina_naukowa_id, rekord_id);

CREATE INDEX bpp_autorzy_mat_9
    ON bpp_autorzy_mat (kierunek_studiow_id);

CREATE INDEX bpp_autorzy_mat_10
    ON bpp_autorzy_mat (oswiadczenie_ken);

CREATE INDEX bpp_autorzy_mat_11
    ON bpp_autorzy_mat (przypieta);

CREATE INDEX bpp_autorzy_mat_12
    ON bpp_autorzy_mat (data_oswiadczenia);
...
ALTER TABLE bpp_autorzy_mat
    ADD CONSTRAINT typ_odpowiedzialnosci_id_fk FOREIGN KEY (typ_odpowiedzialnosci_id) REFERENCES bpp_typ_odpowiedzialnosci (id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE bpp_autorzy_mat
    ADD CONSTRAINT kierunek_studiow_id_fk FOREIGN KEY (kierunek_studiow_id) REFERENCES bpp_kierunek_studiow (id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED;
