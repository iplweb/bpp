...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(verbose_name=b'OpenAccess: czas udost\xc4\x99pnienia', blank=True, to='bpp.Czas_Udostepnienia_OpenAccess', null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='wydawnictwo_ciagle',
        ...
        migrations.AlterField(
            model_name='wydawnictwo_ciagle',
            name='openaccess_tryb_dostepu',
            field=models.ForeignKey(verbose_name=b'OpenAccess: tryb dost\xc4\x99pu', blank=True, to='bpp.Tryb_OpenAccess_Wydawnictwo_Ciagle', null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='wydawnictwo_ciagle',
            name='openaccess_wersja_tekstu',
            field=models.ForeignKey(verbose_name=b'OpenAccess: wersja tekstu', blank=True, to='bpp.Wersja_Tekstu_OpenAccess', null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
