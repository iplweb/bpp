...
NIEPOPRAWNY_KOD = "[niepoprawny kod]"
WYZSZA_PUNKTACJA = DZIEDZINY_HST
...
LINK_PI_ADD_STATEMENTS = (
    "{pbn_api_root}/institution/wrk-imp/publications/{uuid}/add-statements"
)
