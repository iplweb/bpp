...
> ⚠️ **DOKUMENT HISTORYCZNY (auto-generowany, 2026-01-16).** Nie odzwierciedla
> obecnego stanu kodu: liczby tokenów/linii są nieaktualne, opisuje usunięty
> krok `data_integration`, a warstwa WebSocket/Channels (`consumers.py`,
> `routing.py`) została **usunięta** (2026-06-12) — cały realtime realizuje
> polling HTMX. Aktualny przegląd:
> [`docs/deweloper/przeglad-pbn-import-2026-06-12.md`](../../../docs/deweloper/przeglad-pbn-import-2026-06-12.md).
